...
<%@ include file="includes/header.php" %>
    ...
    <div class="container marketing">
      ...
      <div class="row featurette">
        <div class="col-md-5">
          <img class="featurette-image img-responsive" src="img/noticia1.jpg" alt="Generic placeholder image" width="300" height="300">
        </div>
        <div class="col-md-7">
          <h2 class="featurette-heading">GTA V <span class="text-muted">It'll blow your mind.</span></h2>
          <p class="lead">Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo. <a href="#" class="btn btn-info">Ver más &raquo;</a></p>
        </div>
      </div>
      ...
      <div class="row featurette">
        <div class="col-md-5">
          <img class="featurette-image img-responsive" src="img/noticia2.jpg" alt="Generic placeholder image" width="300" height="300">
        </div>
        <div class="col-md-7">
          <h2 class="featurette-heading">ComiCON <span class="text-muted">See for yourself.</span></h2>
          <p class="lead">Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo. <a href="#" class="btn btn-info">Ver más &raquo;</a></p>
        </div>
      </div>
      ...
      <div class="row featurette">
        <div class="col-md-5">
          <img class="featurette-image img-responsive" src="img/noticia.jpg" alt="Generic placeholder image" width="300" height="300">
        </div>
        <div class="col-md-7">
          <h2 class="featurette-heading">Halo 4 <span class="text-muted">Checkmate.</span></h2>
          <p class="lead">Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo. <a href="#" class="btn btn-info">Ver más &raquo;</a></p>
        </div>
      </div>
